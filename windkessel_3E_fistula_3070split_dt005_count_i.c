...
real Rp_Ar = 1.339104283251380e+09;		/* Artery Proximal Resistance (Near)*/
real Rd_Ar = 8.927361888342538e+08;		/* Distal Resistance (Far)*/
real C_Ar  = 1.616037367962929e-10;
real tau_Ar = 0;
...
real Rp_Ve = 5.523805168411944e+08;		/* Proximal Resistance (Near)*/
real Rd_Ve = 3.682536778941296e+08;		/* Distal Resistance (Far)*/
real C_Ve  = 2.577359616692970e-09;
real tau_Ve = 0;
